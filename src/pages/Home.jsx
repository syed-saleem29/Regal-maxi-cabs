...
const whyUs = [
  { icon: <FiClock />,  title: '24/7 Availability',    desc: 'Anytime, any day — always ready to pick you up across Australia.' },
  { icon: <FiShield />, title: 'No Surge Pricing',     desc: 'Fixed fares guaranteed. No hidden fees, no peak-hour surcharges.' },
  { icon: <FiAward />,  title: 'Professional Drivers', desc: 'Licensed, uniformed, background-checked drivers who care about you.' },
        ...
        <div className="container hero-inner">
          ...
          <div className="hero-content">
            ...
            <div className="hero-trust">
              ...
              <span><FiCheckCircle /> 100+ Vehicles</span>
